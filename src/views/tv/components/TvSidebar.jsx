...
function TvSidebar({
    ...
    return (
        <div className={`fixed inset-0 z-50 lg:static lg:block lg:w-1/4 xl:w-1/5 ${isSidebarOpen ? 'block' : 'hidden'}`}>
            ...
            <div className="relative bg-gray-900 lg:bg-transparent h-full w-4/5 lg:w-full max-w-sm p-6 lg:p-0 overflow-y-auto lg:overflow-visible">
                ...
                <div className="space-y-4 sticky top-24">
                    ...
                    <CollapsibleSection title="First Air Year" icon={<FiCalendar className="text-cyan-400" />}>
                        <input
                            type="number"
